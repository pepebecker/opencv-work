...
RUN apt-get -y install libturbojpeg1 libturbojpeg1-dev
...
RUN pip install --upgrade --user Cython
RUN pip install --upgrade --user cffi
RUN pip install --upgrade --user jpegtran-cffi
